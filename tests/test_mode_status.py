...
# operational modes, sil_supplement, gva, single_antenna, nic_supplement).
...
def test_callsign_decode():
    ...
    assert result["nic_supplement"] is True
...
def test_squawk_decode():
    ...
    assert result["nic_supplement"] is False
